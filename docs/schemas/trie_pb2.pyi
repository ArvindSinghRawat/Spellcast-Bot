...
class Trie(_message.Message):
    __slots__ = ["children", "details", "level"]
    ...
    level: int
    def __init__(self, details: _Optional[_Iterable[_Union[Detail, _Mapping]]] = ..., children: _Optional[_Mapping[str, Trie]] = ..., level: _Optional[int] = ...) -> None: ...
